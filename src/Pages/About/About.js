    ...
    <div>
      ...
      <div className="mission-row">
        <div className="mission-desk">
          ...
          <p className="mission-cont">
            ArulAnandar Incubation center (AIC) was constituted in 2023 under
            the able guidance of <b>Rev.Fr. Anbarasu SJ, (Principal,AAC)</b> and
            <b>Rev.Fr. Antonysamy SJ (Secretary,AAC)</b> with due collaboration with
            IPR Cell and IQAC cell under the support of DEAN, Research, AAC. The
            following are the mision and objectives of the AIC. Mission To align
            AAC students with the Start-up India and Startup TN Movement To
            motivate and facilitate the students to develop an innovative idea
            and start Start-up Businesses To convert innovative ideas of the
            students into active business or to present a solution to the
      ...
      <div className="objectives">
        <div className="object-details">
          <h4 className="obj-title">Objectives</h4>
